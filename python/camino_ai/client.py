...
class CaminoAI:
    ...
    def query(self, query: Union[str, QueryRequest]) -> QueryResponse:
        ...
        data = self._make_request("GET", "/query", params=query.model_dump(exclude_none=True))
    ...
    def relationship(self, request: RelationshipRequest) -> RelationshipResponse:
        ...
        """
        data = self._make_request("POST", "/relationship", json=request.model_dump(exclude_none=True))
    ...
    def context(self, request: ContextRequest) -> ContextResponse:
        ...
        """
        data = self._make_request("POST", "/context", json=request.model_dump(exclude_none=True))
    ...
    def journey(self, request: JourneyRequest) -> JourneyResponse:
        ...
        """
        data = self._make_request("POST", "/journey", json=request.model_dump(exclude_none=True))
    ...
    def route(self, request: RouteRequest) -> RouteResponse:
        ...
        """
        data = self._make_request("GET", "/route", params=request.model_dump(exclude_none=True))
